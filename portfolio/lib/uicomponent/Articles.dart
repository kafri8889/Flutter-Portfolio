...
import 'package:portfolio/data/LocalArticleDataProvider.dart';
import 'package:portfolio/data/model/Article.dart';
import 'package:portfolio/uicomponent/ArticleItem.dart';

class Articles extends StatelessWidget {
  Articles({super.key, required this.screenType});

  final ScreenType screenType;
  final List<Article> articles = LocalArticleDataProvider.getInstance().values;
